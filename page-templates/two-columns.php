<?php
/**
 * Template Name: Two-Columns Page Template, With Sidebar
 *
 * Description: This page template has two column layout with a sidebar
 */
get_header();
?>
        ...
        <article class="col-lg-8 p-4">
          ...
          if ( have_posts() ) :
            while ( have_posts() ) : the_post();
              ...
              get_template_part( 'template-parts/page/two', 'column' );
